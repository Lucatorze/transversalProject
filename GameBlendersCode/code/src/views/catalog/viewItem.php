...
<main role="main">
    ...
    <section>
        ...
        <div class="produit">
            <img class="produit-img" src="/assets/img/romolo.png" alt="Romolo">
            <h1 class="produit-title"><?php echo $getItems['name']; ?></h1>
            <p class="produit-info"><?php echo $getItems['gameRules']; ?></p>
            <hr>
        ...
        <div class="produit-tech">
            ...
            <p>Dur&eacute;e d'une partie : 40-60 minutes</p>
        </div>
